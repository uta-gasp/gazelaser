...
namespace GazeLaser.Utils
{
    ...
    {
        private readonly Assembly iAssembly;

        public AssemblyInfo(Assembly aAssembly = null)
        {
            iAssembly = aAssembly ?? Assembly.GetEntryAssembly();
        }
        ...
        public string ProductTitle
        {
            get
            {
                return GetAttributeValue<AssemblyTitleAttribute>(a => a.Title,
                        Path.GetFileNameWithoutExtension(iAssembly.CodeBase));
            }
        }
        ...
        public string Version
        {
            get
            {
                ...
                Version version = iAssembly.GetName().Version;
                if (version != null)
        ...
        {
            object[] attributes = iAssembly.GetCustomAttributes(typeof(TAttr), false);
